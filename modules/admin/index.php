...
(function() {
    ...
    tabs.forEach(function(tab) {
        tab.addEventListener('click', function() {
            ...
            window.location.href = '<?php echo SITE_URL; ?>/modules/admin/admin-root.php?tab=' + tabName;
        });
    });
    ...
    document.querySelectorAll('[data-action="toggle_user"]').forEach(function(btn) {
        btn.addEventListener('click', function() {
            ...
            fetch('<?php echo SITE_URL; ?>/modules/admin/admin-root.php', { method: 'POST', body: p }).then(function(r){return r.json();}).then(function(r){
