...
$page_title = 'Manage Goal Categories';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    switch ($action) {
        case 'save_category':
            echo json_encode(saveGoalCategoryHandler($mysqli, $user_id, $_POST));
            break;
        case 'delete_category':
            echo json_encode(deleteGoalCategoryHandler($mysqli, $user_id, $_POST));
            break;
        default:
...
$categories = getGoalCategories($mysqli, $user_id);
...
<div class="goals-page">
    <div class="goals-toolbar">
        <div>
            <h1 class="goals-title">Manage Goal Categories</h1>
            <p class="goals-subtitle">Organize your goals with custom categories.</p>
        </div>
        <div class="goals-toolbar-actions">
            <a href="<?php echo SITE_URL; ?>/goals.php" class="btn btn-secondary">Back to Goals</a>
        </div>
    </div>
        ...
        <div style="background:var(--bg-card);border:1px solid var(--border-color);border-radius:var(--radius-lg);padding:1.5rem;">
            ...
            <form id="categoryForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="catName" name="name" class="form-control" required placeholder="e.g. Health, Career, Finance">
                </div>
...
<div class="modal" id="deleteCategoryModal" aria-hidden="true">
    ...
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-body">
            <p id="deleteCategoryMessage">Are you sure you want to delete this category? Goals in this category will become uncategorized.</p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('<?php echo SITE_URL; ?>/modules/goals/goal-categories.php', { method: 'POST', body: formData })
    ...
    document.querySelectorAll('.delete-cat-btn').forEach(function(btn) {
        btn.addEventListener('click', function() {
            ...
            document.getElementById('deleteCategoryMessage').textContent =
                'Are you sure you want to delete "' + btn.getAttribute('data-name') + '"? Goals in this category will become uncategorized.';
    ...
    confirmDeleteBtn.addEventListener('click', function() {
        ...
        fetch('<?php echo SITE_URL; ?>/modules/goals/goal-categories.php', { method: 'POST', body: fd })
            .then(function(r) { return r.json(); })
            .then(function(data) {
