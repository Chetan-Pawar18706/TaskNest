...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$auth->verifyCsrfToken($csrf)) {
        ...
        redirect(SITE_URL . '/modules/habits/habits-add.php');
    }
...
$target_count = $_POST['target_count'] ?? '1';
...
<div class="habits-page">
    <div class="habits-toolbar">
        ...
        <div>
            <h1 class="habits-title">Add New Habit</h1>
            <p class="habits-subtitle">Create a new habit to track your progress.</p>
        </div>
    </div>
    ...
    <div style="background:var(--surface);border:1px solid var(--border-color);border-radius:var(--radius-lg);padding:1.25rem;box-shadow:var(--shadow-sm);max-width:720px;">
        <form method="post" action="<?php echo SITE_URL; ?>/modules/habits/habits-add.php">
