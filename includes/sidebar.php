...
<aside class="sidebar" id="mainSidebar">
    ...
    <div class="sidebar-footer">
        ...
        <div class="sidebar-footer-links">
            ...
            <a href="<?php echo SITE_URL; ?>/auth/2fa-setup.php" class="sidebar-footer-link">
        ...
        <a href="<?php echo SITE_URL; ?>/auth/logout.php" class="btn btn-secondary btn-block">Logout</a>
